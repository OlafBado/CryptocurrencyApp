            ...
            <div className="container">
                ...
                <nav className='navbar' style={{display: isNavOpen ? 'block' : 'none'}}>
                    <ul className='navbar__list'>
                        <li onClick={() => {handleDefaultCoinsState(); setIsNavOpen((prev) => !prev)}} className='navbar__list__item'><Link to="/">Home</Link></li>
                        <li onClick={() => {handleDefaultCoinsState(); setIsNavOpen((prev) => !prev)}} className='navbar__list__item'><Link to="/cryptocurrencies">Cryptocurrencies</Link></li>
